...
(function($) {
    ...
    00. All Slick Carousel Activation JS
        0.1 - Home Agency Portfolio Testimonial
    ==================================*/
    ...
    jQuery(document).ready(function($) {
        ...
        ! function() {
            ...
            btnOpen.on('click', function() {
                ...
                $(offCanvas + dataSrc).addClass("show");
                $("body").addClass("fix");

                console.log(offCanvas + dataSrc);
            });
            ...
            let activeId = $(".instagram-gallery"),
                myTemplate = `
                    <div class="instagram-item">
                        <a href="{{link}}" target="_blank" id="{{id}}"><img src="{{image}}"  alt="{{id}}"/></a>
        ...
        /*---------------------------------------
            00. All Slick Slider Activation JS
        -----------------------------------------*/
        ...
        ! function() {
            const proCarousel = $(".portfolio-multipurpose-carousel");
            proCarousel.slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                autoplay: false,
        ...
        ! function() {
            const testSlider = $(".multipurpose-testimonial-slider");
            testSlider.slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                arrows: false,
